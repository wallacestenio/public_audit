...
final class CatalogRepository
{
    ...
    /**
     * Constrói "AND LOWER(col) LIKE LOWER(?)" para cada palavra do termo.
     */
    ...
    /**
     * Executa SQL e retorna array; com &_debug=1 devolve erro no JSON (diagnóstico).
     */
    private function run(string $sql, array $params = []): array
    {
        try {
            ...
            // Diagnóstico no navegador (não use em produção)
    ...
    {
        // Tabela: kyndryl_auditors | Coluna de texto: kyndryl_auditor
        $params = [];
    ...
    {
        // Tabela: petrobras_inspectors | Coluna: petrobras_inspector
        $params = [];
    ...
    {
        // Tabela: audited_suppliers | Coluna: audited_supplier
        $params = [];
    ...
    {
        // Tabela: locations | Coluna: location
        $params = [];
    ...
    {
        // Tabela: categories | Coluna: category
        $params = [];
    ...
    {
        // Tabela: resolver_groups | Coluna: resolver_group
        $params = [];
